  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="bg-gray-950  dark:bg-gray-300 absolute -z-10 top-[-1rem] left-[25rem] sm:left-[35rem]  h-[11.25rem] w-[11.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]" />
        <ThemeContexProvider>
